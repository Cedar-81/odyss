...
import { account, databases, DATABASES, COLLECTIONS, ID, Query} from "../appWrite"
...
export const registerUser = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const userData = await databases.createDocument(DATABASES.MAIN, COLLECTIONS.USERS, ID.unique(), {
...
export const loginUser = createAsyncThunk(
  ...
  async ({ email, password }: { email: string; password: string }, { rejectWithValue }) => {
    try {
      ...
      const users = await databases.listDocuments(DATABASES.MAIN, COLLECTIONS.USERS, [
